        ...
        <div className="resume-section education">
            ...
            <div className="education-content">
                ...
                <div className="studyname">
                    ...
                    <div className="about-course">Bechelors of Science in Information Technology. Focused course on programming in
        C/C++, web technologies, DBMS and many else.</div>
                </div>
            </div>
            <br />
            <div className="education-content">
                ...
                <div className="studyname">
                    ...
                    <div className="about-course">Intermediate qualification specialized in PCM (Physics, Chemistry, Mathematics).
      </div>
                </div>
            </div>
        </div>
